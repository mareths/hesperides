...
import org.hesperides.core.domain.platforms.queries.views.properties.DetailedPropertiesPlatformView;
...
@Value
public class DetailedPropertiesPlatformOutput {
    ...
    @SerializedName("deployed_modules")
    @JsonProperty("deployed_modules")
    List<DetailedPropertiesModuleOutput> deployedModules;

    public DetailedPropertiesPlatformOutput(DetailedPropertiesPlatformView view) {
        ...
        deployedModules = DetailedPropertiesModuleOutput.fromDetailedPropertiesModuleViews(view.getDeployedModules());
    }
    ...
    public static class ModuleOutput {
        ...
        public ModuleOutput(Module.Key moduleKey) {
            name = moduleKey.getName();
            version = moduleKey.getVersion();
            versionType = moduleKey.getVersionType().toString();
        }

        public static List<ModuleOutput> fromModuleKeys(List<Module.Key> moduleKeys) {
            return moduleKeys.stream()
                    .map(ModuleOutput::new)
                    .collect(toList());
        }
    }
    ...
    public static class DetailedPropertiesModuleOutput extends ModuleOutput {
        ...
        public DetailedPropertiesModuleOutput(DetailedPropertiesModuleView view) {
            super(view.getModuleKey().getName(), view.getModuleKey().getVersion(), view.getModuleKey().getVersionType().toString());
        ...
        public static List<DetailedPropertiesModuleOutput> fromDetailedPropertiesModuleViews(List<DetailedPropertiesModuleView> views) {
            return views.stream()
                    .map(DetailedPropertiesModuleOutput::new)
                    .collect(toList());
        }
    }
    ...
    public static class ModuleDetailedPropertyOutput extends DetailedPropertyOutput {
        ...
        @SerializedName("referencing_modules")
        @JsonProperty("referencing_modules")
        List<ModuleOutput> referencingModules;
        @SerializedName("is_not_used")
        @JsonProperty("is_not_used")
        boolean isNotUsed;

        public ModuleDetailedPropertyOutput(String name, String storedValue, String finalValue, String defaultValue, boolean isRequired, boolean isPassword, String pattern, String comment, List<DetailedPropertyOutput> referencedGlobalProperties, List<ModuleOutput> referencingModules, boolean isNotUsed) {
            ...
            this.referencingModules = referencingModules;
        ...
        public ModuleDetailedPropertyOutput(ModuleDetailedPropertyView view) {
            ...
            referencingModules = ModuleOutput.fromModuleKeys(view.getReferencingModules());
